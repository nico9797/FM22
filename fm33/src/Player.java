...
String[] cognomi={"Viola","Santin","Lupini","Lopez","Torres","Ferri","Aldisco","Costa","Giordano","Rizzo","Lombardi","Moretti","Barbieri","Mancini","Conti","Gallo","Bruno","Greco","Russo","Ferrari","Esposito","Romano","Colombo","Ricci","Marino","Bianchi","Rossi","De Caro","Verdi","Pioli","De lio","Dalla","Monti","Rupi","Madi","Di Nero","Di Mauro","Pani"};


    Player() {
        nome=nomi[r.nextInt(15)];
        cognome=cognomi[r.nextInt(38)];
        eta=r.nextInt(16,39);
