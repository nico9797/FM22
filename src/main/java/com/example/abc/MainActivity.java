...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button legheButton,homeButton,play,classificaButton,reset;
    Button seriea,premierleague,laliga,bundesliga,eredivise,ligue1,serieb,championship,ligaportugal,seriec;
    Button juventus,inter,milan,napoli,roma,lazio,atalanta,sampdoria,sassuolo,bologna,torino,udinese,salernitana
            ,empoli,fiorentina,spezia,verona,cremonese,lecce,monza;
...
v9[0] + "-" +v9[1] + " " + serieA.calendario[i + 9][0] + "-" + serieA.calendario[i + 9][1] + "\n");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leghelayout=findViewById(R.id.leghelayout);italianetable=findViewById(R.id.italianetable);
        legheButton=findViewById(R.id.campionatIButton);homeButton=findViewById(R.id.home);
        seriea=findViewById(R.id.seriea);premierleague=findViewById(R.id.premierleague);
        laliga=findViewById(R.id.laliga);bundesliga=findViewById(R.id.bundesliga);
        eredivise=findViewById(R.id.eredivise);ligue1=findViewById(R.id.ligue1);
        serieb=findViewById(R.id.serieb);championship=findViewById(R.id.campionship);
        ligaportugal=findViewById(R.id.ligaportugal);seriec=findViewById(R.id.seriec);
        juventus=findViewById(R.id.juventus);inter=findViewById(R.id.inter);
        milan=findViewById(R.id.milan);napoli=findViewById(R.id.napoli);
        roma=findViewById(R.id.roma);lazio=findViewById(R.id.lazio);
        atalanta=findViewById(R.id.atalanta);sampdoria=findViewById(R.id.sampdoria);
        sassuolo=findViewById(R.id.sassuolo);bologna=findViewById(R.id.bologna);
        torino=findViewById(R.id.torino);udinese=findViewById(R.id.udinese);
        salernitana=findViewById(R.id.salernitana);empoli=findViewById(R.id.empoli);
        fiorentina=findViewById(R.id.fiorentina);spezia=findViewById(R.id.spezia);
        verona=findViewById(R.id.verona);cremonese=findViewById(R.id.cremonese);
        lecce=findViewById(R.id.lecce);monza=findViewById(R.id.monza);
        ...
        classificaButton=findViewById(R.id.classificabutton);
        table=findViewById(R.id.classificatable);
        reset=findViewById(R.id.reset);

        classificaButton.setOnClickListener(this);
